...
export const AVERAGE_POINTS_HOME_OPTIONS = {
  value: 'home.average',
  label: 'Média de pontos mandante'
}
export const AVERAGE_POINTS_AWAY_OPTIONS = {
  value: 'away.average',
  label: 'Média de pontos visitante'
}
export const DEFENSES_OPTION = { value: 'defenses', label: 'Defesas' }
export const DEFENSES_TO_SUFFER_GOAL_OPTION = {
  value: 'defensesToSufferGoal',
